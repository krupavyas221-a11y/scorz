...
<head>
    ...
    <style>
        ...
        .header p { color: #c7d2fe; margin: 4px 0 0; font-size: 0.85rem; }
        .body { padding: 28px 32px; }
        .body p { color: #374151; line-height: 1.6; margin: 0 0 14px; font-size: 0.9rem; }
        ...
        .creds td { padding: 6px 0; font-size: 0.875rem; color: #374151; }
        .creds td:first-child { color: #6b7280; width: 150px; font-weight: 500; }
        .creds td strong { color: #111827; font-family: monospace; font-size: 0.95rem; }
        .btn { display: inline-block; background: #6366f1; color: #fff; text-decoration: none;
               padding: 10px 24px; border-radius: 6px; font-size: 0.875rem; font-weight: 600; margin: 8px 0 20px; }
        ...
        .warning { background: #fffbeb; border: 1px solid #fcd34d; border-radius: 6px;
                   padding: 10px 14px; font-size: 0.8rem; color: #92400e; margin-top: 16px; }
    </style>
</head>
<body>
<div class="wrap">
    <div class="header">
        ...
        <p>School Admin Account Created</p>
    </div>
    <div class="body">
        <p>Hello <strong>{{ $user->name }}</strong>,</p>
        <p>
            Your School Admin account has been created for <strong>{{ $school->name }}</strong>.
        ...
        <div class="warning">
            ⚠ For security, please change your password and PIN after your first login.
        </div>
    </div>
    <div class="footer">
        This email was sent automatically by Scorz. Please do not reply to this email.
    </div>
</div>
</body>
</html>
